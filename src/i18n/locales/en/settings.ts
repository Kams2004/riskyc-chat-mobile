export default {
  ...
  linkDevice: {
    title: 'Link a device',
    scanInstruction: 'Point your camera at the QR code shown on RiskyC Chat for web',
    cameraPermissionTitle: 'Camera access needed',
    cameraPermissionBody: 'Allow camera access to scan a QR code.',
    grantAccess: 'Grant access',
    confirmTitle: 'Link this device?',
    confirmBody: '"{{device}}" will be able to read your messages and send messages on your behalf.',
    linkAction: 'Link device',
    linkedTitle: 'Device linked',
    linkedBody: '"{{device}}" is now signed in.',
    expiredTitle: 'QR code expired',
    expiredBody: 'This code is no longer valid — refresh it on the other device and scan again.',
    errorTitle: 'Could not link device',
