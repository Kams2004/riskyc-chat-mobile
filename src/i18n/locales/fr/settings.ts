export default {
  ...
  linkDevice: {
    title: 'Lier un appareil',
    scanInstruction: 'Pointez votre appareil photo vers le code QR affiché sur RiskyC Chat pour le web',
    cameraPermissionTitle: 'Accès à la caméra requis',
    cameraPermissionBody: "Autorisez l'accès à la caméra pour scanner un code QR.",
    grantAccess: 'Autoriser',
    confirmTitle: 'Lier cet appareil ?',
    confirmBody: '« {{device}} » pourra lire vos messages et envoyer des messages en votre nom.',
    linkAction: "Lier l'appareil",
    linkedTitle: 'Appareil lié',
    linkedBody: '« {{device}} » est maintenant connecté.',
    expiredTitle: 'Code QR expiré',
    expiredBody: "Ce code n'est plus valide — actualisez-le sur l'autre appareil et scannez à nouveau.",
    errorTitle: "Impossible de lier l'appareil",
